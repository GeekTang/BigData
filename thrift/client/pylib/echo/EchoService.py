...
class Client(Iface):
  ...
  def echo(self, welcome):
    ...
    Parameters:
     - welcome
    """
    self.send_echo(welcome)
    return self.recv_echo()

  def send_echo(self, welcome):
...
class Processor(Iface, TProcessor):
  ...
  def process_echo(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = echo_result()
    result.success = self._handler.echo(args.welcome)
...
class echo_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'welcome', None, None, ), # 1
  )
  ...
  def write(self, oprot):
    ...
    if self.welcome is not None:
      oprot.writeFieldBegin('welcome', TType.STRING, 1)
      oprot.writeString(self.welcome)
      oprot.writeFieldEnd()
